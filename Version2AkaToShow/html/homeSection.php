  ...
  <div class="hero-carousel carousel-animated carousel-animate-slide" data-autoplay="true">
    <div class='carousel-container'>
      <div class='carousel-item has-background is-active'>
        <img class="is-background" src="./images/stock1.jpg" alt="" />
      </div>
      <div class='carousel-item has-background'>
        <img class="is-background" src="./images/stock2.jpg" alt="" />
      </div>
      <div class='carousel-item has-background'>
        <img class="is-background" src="./images/stock3.jpg" alt="" />
      </div>
      <div class='carousel-item has-background'>
        <img class="is-background" src="./images/stock5.jpg" alt="" />
      </div>
    </div>
