	...
	success : function(data){
		...
		{	
			...
			for(let i=0; i<data.response.length; ++i){
				...
				newHTMLbed += `<br><button class="button is-rounded is-dark addPicProject" id="${data.response[i]['proyectId']}">
	 							Add Picture</button>`;
	 			if(data.response[i]['pics'][1][0]!=undefined){
	...
	success : function(data){
		...
		{	
			...
			let auxHTMLliv="";
				...
				newHTMLliv += `<br><button class="button is-rounded is-dark addPicProject" id="${data.response[i]['proyectId']}">
	 							Add Picture</button>`;
	 			if(data.response[i]['pics'][1][0]!=undefined){
	...
	success : function(data){
		...
		{	
			...
			let auxHTMLkit="";
				...
				newHTMLkit += `<br>	<button class="button is-rounded is-dark addPicProject" id="${data.response[i]['proyectId']}">
	 							Add Picture</button>`;
	 			if(data.response[i]['pics'][1][0]!=undefined){
	...
	success : function(data){
		...
		{	
			...
			let auxHTMLdin="";
				...
				newHTMLdin += `<br>	<button class="button is-rounded is-dark addPicProject" id="${data.response[i]['proyectId']}">
	 							Add Picture</button>`;
	 			if(data.response[i]['pics'][1][0]!=undefined){
	...
	success : function(data){
		...
		{	
			...
			for(let i=0; i<data.response.length; ++i){
				...
				newHTMLbat += `<br><button class="button is-rounded is-dark addPicProject" id="${data.response[i]['proyectId']}">
	 							Add Picture</button>`;
	 			if(data.response[i]['pics'][1][0]!=undefined){
