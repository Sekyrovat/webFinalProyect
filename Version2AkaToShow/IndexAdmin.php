...
<html>
	...
	<body>
		...
		<main>
			...
			<section id="BeforeAfterSection" class="is-hidden">
				<div class="buttons is-centered">
					...
					<button class="button is-rounded is-dark" id="buttonAddBeforeAfter" >Add</button>
				</div>
				<div id="notiBeforeAfter" class="is-hidden">
					<div class="notification is-grey">
  						<button class="delete" id="deleteAddBeforeAfter"></button>
  						<form>
  							<?php include 'html/AddBeforeAfter.php'; ?>
						  </form>
						</div>
					</div>
				<div>
		...
		<script type="text/javascript" src="js/GetProductsJQ.js"></script>
		<script type="text/javascript" src="js/GetProjectsJQ.js"></script>
		<script type="text/javascript" src="js/GetProjectsBeforeAfterJQ.js"></script>
  </body>
</html>