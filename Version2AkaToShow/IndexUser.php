...
<html>
	...
	<body>
		...
		<main>
			...
			<section id="CartSection" class="is-hidden">
				<div id="CartID">
					<p class="title is-1 has-text-centered">My Cart</p>
					<p class="title is-3 has-text-centered">Total:</p>
					<p class="title is-3 has-text-centered" id="TotalCart"></p>
					<ul id="CartList">
					</ul>
		...
		<script type="text/javascript" src="js/UserJQ.js"></script>
		<script type="text/javascript" src="js/SearchJQ.js"></script>
		<script type="text/javascript" src="js/GetProductsUserJQ.js"></script>
		<script type="text/javascript" src="js/GetProjectsJQUser.js"></script>
		<script type="text/javascript" src="js/GetProjectsBeforeAfterUserJQ.js"></script>
